...
BEGIN
    ...
    -- INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    -- VALUES (N'YourMigrationName', N'9.0.6');
END;
...
ALTER TABLE Cours
ADD CONSTRAINT FK_Cours_Session
FOREIGN KEY (SessionId) REFERENCES Session(Id);

-- 2. Suppression de la colonne SessionName qui devient redondante avec la relation
-- Vous pouvez conserver cette colonne si nécessaire pour des raisons d'affichage
ALTER TABLE Cours
